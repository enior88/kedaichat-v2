                ...
                <div className="bg-white rounded-[40px] shadow-2xl shadow-green-900/10 p-10 md:p-16 border border-gray-100">
                    ...
                    <div className="prose prose-lg text-gray-600 space-y-10 max-w-none">
                        ...
                        <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-10 rounded-3xl border border-gray-800 shadow-xl mt-12 text-center">
                            ...
                            <a href="mailto:kedaichat@gmail.com" className="inline-flex w-full md:w-auto items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1fb855] text-white px-4 md:px-8 py-4 rounded-xl font-black transition-all shadow-lg shadow-green-900/50 active:scale-95 text-sm md:text-lg overflow-hidden whitespace-nowrap overflow-ellipsis">
                                <Mail size={18} />
                                kedaichat@gmail.com
                            </a>
                        </section>
