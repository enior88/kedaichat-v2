...
export async function middleware(request: NextRequest) {
    ...
    const reservedPaths = ['admin', 'api', 'billing', 'dashboard', 'login', 'onboarding', 'orders', 'products', 'reseller', 'wallet', 'tools', 'shop', 'analytics', 'settings', 'checkout', '_next', 'favicon.ico', 'logo.png', 'favicon.png'];
